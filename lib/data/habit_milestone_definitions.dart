...
const List<HabitMilestone> habitMilestones = [
  ...
  HabitMilestone(
    ...
    expectation: 'Cravings and anxiety may still feel intense.',
    benefit: 'You are moving through one of the hardest early phases of recovery.',
  ),
  HabitMilestone(
    id: 'quit_cocaine_day_21',
    trackId: HabitMilestoneTracks.quitCocaine,
    targetDays: 21,
    title: 'Apex of withdrawal',
    expectation: 'Be very aware of your triggers.',
    benefit: 'You are moving towards making a habit out of NOT doing cocaine.',
  ),
  HabitMilestone(
    ...
    expectation: 'Mind your triggers and know what to expect when stress arises.',
